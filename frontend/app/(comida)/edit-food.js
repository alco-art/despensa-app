...
const styles = StyleSheet.create({
    ...
    sectionTitle: { fontSize: 16, fontWeight: 'bold', marginTop: 8, marginBottom: 12 },
    ...
    buttonBar: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', borderTopWidth: 1, paddingBottom: 8, borderTopColor: '#ddd', backgroundColor: '#ffffff', paddingVertical: 8 },
    cancelButton: { flex: 1, marginLeft: 8, marginRight: 4, paddingVertical: 10, borderRadius: 6, borderWidth: 1, borderColor: '#999', alignItems: 'center' },
    submitButton: { flex: 1, marginLeft: 4, marginRight: 8, paddingVertical: 10, borderRadius: 6, borderWidth: 1, backgroundColor: '#4a5a6a', alignItems: 'center' }
});
